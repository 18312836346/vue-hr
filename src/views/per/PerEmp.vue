        ...
        <div style="margin-top: 10px">
            <el-table
                ...
                <el-table-column
                       ...
                       >
                    <template slot-scope="scope">
                        <el-button @click="showEditEmpView(scope.row)" style="padding: 3px; width:50px;height:30px" >编辑</el-button>
                        <!-- <el-button style="padding: 3px" size="mini" type="primary">查看高级资料</el-button> -->
                        <el-button @click="deleteEmp(scope.row)" style="padding: 3px; width:50px;height:30px"  type="danger">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
                        ...
                        <el-col :span="5">
                            <el-form-item label="所属部门:" prop="departmentId">
                                <el-popover
                                        ...
                                        v-model="popVisible">
                                        <div slot="reference"
                                         style="width: 150px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box;margin-top:10px"
